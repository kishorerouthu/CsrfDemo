...
@Service
public class BankDBQueryExecutorServiceImpl implements BankDBQueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(BankDBQueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("BankDBWMQueryExecutor")
